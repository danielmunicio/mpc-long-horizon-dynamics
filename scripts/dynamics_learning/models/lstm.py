...
class LSTM(nn.Module):
  def __init__(self, input_size, encoder_dim, encoder_sizes, num_layers, history_length, dropout,
    ...
    self.encoder = nn.LSTM(input_size=input_size, hidden_size=encoder_sizes,
...
if __name__=='__main__':
    ...
    model = LSTM(input_size, encoder_dim, encoder_sizes, num_layers, history_len, dropout, output_type)
